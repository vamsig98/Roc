...
var ActiveWorkItemsComponent = /** @class */ (function () {
    function ActiveWorkItemsComponent(_workItemService, _router, toastr) {
        ...
        this.queryParam = {};
        this._workItemService.getactiveworkitemsObj.subscribe(function (data) {
            _this.sources = data;
        });
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_shared_services_auth_auth_service__ = __webpack_require__("../../../../../src/app/shared/shared-services/auth/auth.service.ts");
...
var ProcessesInitComponent = /** @class */ (function () {
    ...
    ProcessesInitComponent.prototype.getStakeholderData = function () {
        ...
        this._workItemService.getStakeholderData(this.process.name).subscribe(function (data) {
            ...
            console.log(_this.stakeholderInformation);
            _this.showStakeholder = true;
        });
    };
    ProcessesInitComponent.prototype.getActiveWorkItems = function () {
        var _this = this;
        var obj = this._workItemService.selectedDate;
        var _httpObservable = this._workItemService.getActiveWorkItemsByProcessName(this.process.name, obj);
        _httpObservable.subscribe(function (data) {
            _this._workItemService.sendactiveworkitemsObj.next(data.result["active_work_items"]);
    ...
    ProcessesInitComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__shared_shared_services_work_items_work_items_service__["a" /* WorkItemsService */],
            ...
            __WEBPACK_IMPORTED_MODULE_5__shared_shared_services_auth_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_6__angular_material__["g" /* MatDialog */]])
...
var DeleteConfirmationDialogComponent = /** @class */ (function () {
    ...
    DeleteConfirmationDialogComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_6__angular_material__["i" /* MatDialogRef */], Object])
