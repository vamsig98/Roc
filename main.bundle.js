...
var AppComponent = /** @class */ (function () {
    function AppComponent(_auth, _router) {
        ...
        this.checkCookie();
        this.email = this.cookieEmail.replace(/['"]+/g, '');
        if (this.email == null || this.email == "") {
            ...
            // window.location.assign("http://192.168.99.100:8000/saml/sso");
        }
        else {
            this._auth.getclientDetails().subscribe(function (data) {
                // console.log(data);
    ...
    AppComponent.prototype.checkCookie = function () {
        this.cookieEmail = this.getCookie("email");
    };
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__app_shared_shared_services_auth_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */]])
    ], AppComponent);
    return AppComponent;
}());
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.setAppFavicon = function (id, browser_title, icon) {
        ...
        document.title = browser_title ? browser_title : 'ENSO PULSE';
    };
...
var MyHttpInterceptor = /** @class */ (function () {
    ...
    MyHttpInterceptor.prototype.intercept = function (req, next) {
        ...
        return next.handle(authReq)
            ...
            return __WEBPACK_IMPORTED_MODULE_13_rxjs_Rx__["b" /* Observable */].throw(error);
        });
    };
...
var WorkItemsService = /** @class */ (function () {
    function WorkItemsService(_httpClient, _config) {
        ...
        this.activePage = '';
        this.subwayMapSubject = new __WEBPACK_IMPORTED_MODULE_3_rxjs_Rx__["c" /* Subject */]();
        this.workItemDetails = {};
        this.workItemDetailsFilter = 'All';
        this.subwayMapData = {};
        this.exceptionrecords = false;
        this.getsubway = true;
        this.dropCountsLoader = false;
        this.hasChanged = new __WEBPACK_IMPORTED_MODULE_3_rxjs_Rx__["c" /* Subject */]();
        this.hasChangedObserver = this.hasChanged.asObservable();
        this.queryParam = '';
        this.processesListSubject = new __WEBPACK_IMPORTED_MODULE_3_rxjs_Rx__["c" /* Subject */]();
        this.processesListObserver = this.processesListSubject.asObservable();
        this._workItems = [];
        this.sendObj = new __WEBPACK_IMPORTED_MODULE_3_rxjs_Rx__["a" /* BehaviorSubject */](null);
        this.getObj = this.sendObj.asObservable();
        this.sendactiveworkitemsObj = new __WEBPACK_IMPORTED_MODULE_3_rxjs_Rx__["a" /* BehaviorSubject */](null);
        this.getactiveworkitemsObj = this.sendactiveworkitemsObj.asObservable();
    ...
    //   public getObj = this.sendObj.asObservable().subscribe((data)=>{
    //     this.dropcount_overlay_data =  data;
    //  });
    /**
    ...
    WorkItemsService.prototype.getRecordsBySourceId = function (sourceId, paginationData) {
        ...
        return __WEBPACK_IMPORTED_MODULE_3_rxjs_Rx__["b" /* Observable */].of({ result: this.workItemDetails.recordDetails || [], total: total });
    };
    ...
    WorkItemsService.prototype.getActiveWorkItemsByProcessName = function (processName, obj) {
        if (this._config.config.useMockData) {
            return this._httpClient.get('assets/mock-data/processActiveWorkItems.json');
        }
        else {
            return this._httpClient.post(this._config.config.apiUrl + '/workitems/active/' + processName, obj);
        }
    };
    ...
    WorkItemsService.prototype.getDateWiseData = function (data) {
        if (this._config.config.useMockData) {
            return this._httpClient.get('assets/mock-data/workItems.json');
        }
        else {
            return this._httpClient.post(this._config.config.apiUrl + '/workitems/active', data);
        }
    };
    ...
    WorkItemsService.prototype.getDropcountsData = function (data) {
        if (this._config.config.useMockData) {
            return this._httpClient.get('assets/mock-data/dropcounts.json');
        }
        else {
            return this._httpClient.post(this._config.config.apiUrl + '/records/dropped', data);
        }
    };
    WorkItemsService.prototype.getExceptionssData = function (data) {
        if (this._config.config.useMockData) {
            return this._httpClient.get('assets/mock-data/workItemDetail.json');
        }
        else {
            return this._httpClient.post(this._config.config.apiUrl + '/claims/records/errors', data);
        }
    };
    WorkItemsService.prototype.getClaimsData = function () {
        if (this._config.config.useMockData) {
            return this._httpClient.get('assets/mock-data/claimstypes.json');
        }
        else {
            return this._httpClient.get(this._config.config.apiUrl + '/claims/types');
        }
    };
