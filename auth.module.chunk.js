...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_shared_shared_services_config_config_service__ = __webpack_require__("../../../../../src/app/shared/shared-services/config/config.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(_auth, _router, config) {
        this._auth = _auth;
    ...
    LoginComponent.prototype.getLoggedInUserInfo = function () {
        ...
        setTimeout(function () {
            ...
            if (user === null) {
                ...
                window.location.assign(_this.config.config.baseUrl);
            }
            else {
    ...
    LoginComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__shared_shared_services_auth_auth_service__["a" /* AuthService */],
            __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */], __WEBPACK_IMPORTED_MODULE_3__app_shared_shared_services_config_config_service__["a" /* ConfigService */]])
    ], LoginComponent);
